...
public:
    ...
    static void adaptPointCloudFrame(std::shared_ptr<uvgvpcc_dec::Frame> frame, uvgvpcc_dec::API::point_cloud_frame_stream* output, const bool& in_order_output, const std::string& outputFilePath);
